...
apt-get autoremove
apt-get autoclean
apt-get -y install build-essential libxml2-dev unzip
apt-get -y install nginx nginx-extras python3 python3-pip python-virtualenv uwsgi uwsgi-plugin-python3
